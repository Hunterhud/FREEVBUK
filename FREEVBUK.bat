@echo off
powershell -Command "Add-Type -AssemblyName PresentationFramework; "[System.Windows.MessageBox]::Show('You just executed a malicious file please keep in mind that i am not responible for any damages!!! Proceed?', 'Error', 4, 16)"
set /p input=
